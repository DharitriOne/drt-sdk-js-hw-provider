import { Address, SignableMessage, Transaction } from "@dharitri-sdk/core";
...
describe("test hwProvider", () => {
    ...
    it("should signMessage", async () => {
        const message = new SignableMessage({
            ...
            address: Address.fromBech32("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8"),
            version: 42
        });
        ...
        assert.equal(signedMessage.address.toString(), "moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8");
